...
/* ToDo: add here your plic device specific external interrupt numbers.
    ...
    PLIC_MVU0_IRQn           = 17,               /*!< Device external Interrupt 17 MVU */
    PLIC_DMA_IRQn            = 18,               /*!< Device external Interrupt 17 MVU */
    PLIC_INT_MAX,
} IRQn_Type;
...
#endif
#define __PLIC_INTNUM             19                    /*!< Set to 1 - 1024, total interrupt sources of PLIC Unit */
